...
public class EnchantmentMending extends Enchantment {
	...
	public EnchantmentMending(int par1, int par2, EnumEnchantmentType par3EnumEnchantmentType) {
		...
		this.setName(Strings.MENDING_NAME);
	}
	...
	public static void tryActivate(ItemStack itemStack) {
		...
		if (Abyss.rng.nextInt(rates[lvl - 1]) == 0) {
			...
			// Chaos cost
			ChaosHandler.addChaos(Config.CHAOS_COST_MENDING);
		}
	}
    ...
    public boolean canApply(ItemStack par1ItemStack) {
    	...
    	if ((par1ItemStack.itemID >= ModItems.swordAbyssRuby.itemID &&
    			par1ItemStack.itemID <= ModItems.hoeAbyssTopazPlus.itemID) ||
    			par1ItemStack.itemID == Item.book.itemID) {
