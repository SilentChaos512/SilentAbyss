...
public class ConfigHandler {
    ...
    public static void init(File file) {
		...
		try {
			...
			BlockIds.ABYSSITE_ORE = c.getBlock(Strings.ABYSSITE_ORE_NAME, BlockIds.ABYSSITE_ORE_DEFAULT).getInt(BlockIds.ABYSSITE_ORE_DEFAULT);
			...
			BlockIds.ABYSSITE_BLOCK = c.getBlock(Strings.ABYSSITE_BLOCK_NAME, BlockIds.ABYSSITE_BLOCK_DEFAULT).getInt(BlockIds.ABYSSITE_BLOCK_DEFAULT);
...
//			BlockIds.BRICK_STAIRS = getBlockId(Strings.BRICK_STAIRS_NAME, BlockIds.BRICK_STAIRS_DEFAULT);
			...
			ItemIds.ABYSSITE = c.getItem(Strings.ABYSSITE_NAME, ItemIds.ABYSSITE_DEFAULT).getInt(ItemIds.ABYSSITE_DEFAULT);
