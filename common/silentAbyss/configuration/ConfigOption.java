...
public abstract class ConfigOption {
    ...
    /**
     * Checks certain config values that might cause errors. If the deriving
     * class's validate override does not have code to check this ConfigOption's
     * value, a warning message should be output to the log file.
     * 
     * @return
     */
