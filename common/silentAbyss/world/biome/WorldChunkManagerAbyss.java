...
public class WorldChunkManagerAbyss extends WorldChunkManager {
    ...
    protected WorldChunkManagerAbyss() {
    ...
    public WorldChunkManagerAbyss(long seed, WorldType worldType) {
        ...
        this();
        GenLayer[] genLayer = GenLayerAbyss.makeWorld(seed);
        this.genBiomes = genLayer[0];
        this.biomeIndexLayer = genLayer[1];
    }

    public WorldChunkManagerAbyss(World world) {

        this(world.getSeed(), world.provider.terrainType);
    }

    public List<BiomeGenBase> getBiomeToSpawnIn() {
