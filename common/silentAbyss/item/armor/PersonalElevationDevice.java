...
public class PersonalElevationDevice extends ItemSA {
    ...
    public String getUnlocalizedName(ItemStack stack) {
        ...
        return (new StringBuilder().append("item.").append(Strings.RESOURCE_PREFIX).append(Strings.PERSONAL_ELEVATION_DEVICE_NAME)).toString();
    }
    
    public static void addRecipes() {
        
        GameRegistry.addShapedRecipe(new ItemStack(ModItems.personalElevationDevice), "cac", "cgc", "cpc",
                'c', AbyssGem.getGem(Reference.INDEX_CONUNDRUMITE),
                'a', AbyssGem.getGem(Reference.INDEX_ABYSSITE),
                'p', AbyssGem.getGem(Reference.INDEX_PURITE),
                'g', Item.ingotGold);
    }
    ...
    public static boolean playerHasEquipped(EntityPlayer player) {
        ...
        return player.inventory.armorInventory[2] != null && player.inventory.armorInventory[2].itemID == ModItems.personalElevationDevice.itemID;
    }
