...
public class ItemTorchPlacer extends ItemSA {
    ...
    public void onUpdate(ItemStack par1ItemStack, World par2World, Entity par3Entity, int par4, boolean par5) {
        ...
        if (getDamage(par1ItemStack) > 0 && player.inventory.hasItem(Block.torchWood.blockID)) {
            player.inventory.consumeInventoryItem(Block.torchWood.blockID);
            setDamage(par1ItemStack, getDamage(par1ItemStack) - 1);
        }
    }
