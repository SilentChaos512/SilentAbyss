...
public class SigilScepterRecipe implements IRecipe {
    ...
    public boolean matches(InventoryCrafting inventorycrafting, World world) {
        ...
        return numColorSigils <= 1 && numEffectSigils <= 1 && numScepters == 1;
    }

    @Override
    public ItemStack getCraftingResult(InventoryCrafting inventorycrafting) {

        ItemStack scepter = null, colorSigil = null, effectSigil = null, s = null;
    ...
    private boolean isColorSigil(ItemStack stack) {
        ...
        return stack != null && // not null,
                stack.getItem().itemID == ModItems.sigilStone.itemID && // is a
                                                                        // sigil
                                                                        // stone,
                                                                        // and
                stack.getItemDamage() > 0 && stack.getItemDamage() < 17; // damage
                                                                         // value
                                                                         // in
                                                                         // [1,
                                                                         // 16]
    ...
    private boolean isEffectSigil(ItemStack stack) {
        ...
        return stack != null && // not null,
                stack.getItem().itemID == ModItems.sigilStone.itemID && // is a
                                                                        ...
                                                                        // stone,
                                                                        // and
                stack.getItemDamage() > 16 && stack.getItemDamage() < 26; // damage
                                                                          // value
                                                                          // in
                                                                          // [17,
                                                                          // 25]
